<template>
  <svg
    ...
    height="20px"
    viewBox="0 0 400 400"
    style="enable-background:new 0 0 400 400; opacity: 0.8"
    xml:space="preserve"
    fill="#202427"
  >
    <g>
      <g>
        <path
          d="M199.996,0C89.713,0,0,89.72,0,200s89.713,200,199.996,200S400,310.28,400,200S310.279,0,199.996,0z M199.996,373.77
        ...
        />
        <path
          d="M272.406,134.526L169.275,237.652l-41.689-41.68c-5.123-5.117-13.422-5.12-18.545,0.003
